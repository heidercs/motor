...
EDR::EDR(int _type_edr, double _epsilon)
{
    this->type_edr=_type_edr;    
    this->epsilon=0.05;
...
bool EDR::cumple_condicion(Object* p, Object* q, int i, int j)
{
    double d;
    bool correct=true;
    ...
    {                
        if(type_edr==0)//si es LCS sobre secuencias discretas, verificar igualdad 		
...
double EDR::d(Object *p,Object *q)
{
    if(!(dynamic_cast<Vector*>(p) && dynamic_cast<Vector*>(q)) &&
